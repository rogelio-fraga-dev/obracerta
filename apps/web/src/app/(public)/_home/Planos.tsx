...
const PLANOS_PROFISSIONAL: PlanoView[] = [
  {
    ...
    desc: "Perfil básico para conhecer a plataforma. Aparece, mas não recebe pedidos.",
    sim: ["Perfil na busca", "Nota geral visível", "Nº de obras concluídas"],
    nao: [
      "Foto de perfil",
      "Nome completo",
  ...
  },
  {
    ...
    destaque: true,
    desc: "Perfil completo. Você aparece com tudo desbloqueado e recebe pedidos.",
    sim: [
    ...
    nao: ["Dar lances em obras"],
  },
  {
    nome: "Especialista",
    preco: "R$99",
    periodo: "/mês · cancele quando quiser",
    desc: "Para quem quer ir atrás das obras. Máximo alcance e lances exclusivos.",
    sim: [
