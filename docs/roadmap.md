...
- [~] **7.5 — Monetização** (Fase 4) _(contratação de plano já saiu na 7.1)_:
  ...
  - [ ] **Gating por entitlements** (parte 2): "Meu plano" (plano vigente + features liberadas/bloqueadas via `/me/entitlements`).
