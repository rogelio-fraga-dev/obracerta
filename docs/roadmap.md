...
- [~] **7.3 — Busca, perfil público e obras** (Fase 5):
  ...
  - [ ] **Obras + lances sigilosos** (parte 2): contratante abre obra + vê propostas + adjudica; profissional descobre obras abertas + envia lance sigiloso.
