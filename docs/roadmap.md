...
- [~] **7.2 — Agenda & agendamento** (Fase 2):
  ...
  - [ ] **Pedidos + termos** (parte 2): criar/gerir pedido (máquina de estados aprovar/recusar/iniciar/concluir/cancelar), aceite de termos bilateral.
  - [ ] **Penalidades/taxa de aceitação** (parte 3): painel do profissional (`/penalties/me/summary`).
