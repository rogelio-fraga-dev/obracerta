...
- [~] **7.4 — Reputação & moderação** (Fase 3):
  ...
  - [ ] **Denúncia + suspensão/apelação** (parte 2): denunciar conteúdo/perfil; painel da própria suspensão + apelação. (Fila do moderador → 7.6 Admin.)
