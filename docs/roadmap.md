...
- [~] **7.6 — Admin UI** (Melhoria #4) consumindo a API da Fase 6:
  ...
  - [ ] **Filas de moderação/financeiro** (parte 2): fila de denúncias + apelações (resolver) e reembolsos pendentes (aprovar/recusar) — exige endpoints de listagem no backend (apelações APELADA, reembolsos SOLICITADO).
